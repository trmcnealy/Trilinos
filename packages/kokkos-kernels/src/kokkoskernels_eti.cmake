...
MACRO(KOKKOSKERNELS_GENERATE_ETI FUNCTION_NAME SUBFOLDER)
  ...
  FOREACH(ETI ${${FUNCTION_NAME}_eti})
    ...
    SET(INST_SOURCE   "impl/gen_cpp/${SUBFOLDER}/${ETI}.cpp")
    SET(INST_TEMPLATE "impl/gen_cpp/${SUBFOLDER}/Kokkos${FUNCTION_NAME}_eti_spec_inst.cpp.in")
  ...
  SET(AVAIL_HEADER   "impl/gen_hpp/Kokkos${FUNCTION_NAME}_eti_spec_avail.hpp")
  SET(AVAIL_TEMPLATE "${AVAIL_HEADER}.in")
  SET(DECL_HEADER   "impl/gen_hpp/Kokkos${FUNCTION_NAME}_eti_spec_decl.hpp")
